...
import { execSync } from 'child_process'; // Importar para ejecutar comandos
...
async function start(file) {
  ...
  // Verificar si canvas está bien instalado o necesita recompilar
  try {
    import("canvas");
  } catch (error) {
    console.log("⚠️ Módulos desactualizados. Intentando reconstruir...");
    try {
      execSync("npm rebuild", { stdio: "inherit" });
      console.log("✅ Módulos recompilados. Reinicia el bot.");
      process.exit(1);
    } catch (err) {
      console.error("❌ No se pudo recompilar. Prueba manualmente con 'npm rebuild'.");
      process.exit(1);
    }
  }
