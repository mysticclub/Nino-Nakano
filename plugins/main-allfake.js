...
global.rcanal = { contextInfo: { mentionedJid: await this.parseMention(text), forwardingScore: 1, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: channelRD.id, serverMessageId: 100, newsletterName: channelRD.name }, externalAdReply: { title: wm, body: dev, mediaType: 1, renderLargerThumbnail: true, previewType: `PHOTO`, thumbnailUrl: icono, sourceUrl: redes }}}, { quoted: m }
