...
if (!args[0]) return m.reply('🚩 Ingresa la cantidad de *🤍 corazones* que deseas apostar.\n\n`Ejemplo:`\n' + `> *${usedPrefix + command}* 10`)
if (isNaN(args[0])) return m.reply('🚩 Ingresa la cantidad de *🤍 corazones* que deseas apostar.\n\n`Ejemplo:`\n' + `> *${usedPrefix + command}* 10`)
...
end = `Perdiste  *${apuesta} 🤍 corazones.*`
users.corazones -= apuesta
}
